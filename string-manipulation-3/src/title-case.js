...
//     var colon = currentWord.includes(':');
//     if (colon) {
//       // var includeColon = currentWord[currentWord.length -1];
//       // index = currentWord.indexOf(includeColon)
//       index = array[array.indexOf(currentWord) + 1];
//       array.splice(index, 1);
//       return currentWord.charAt(0).toUpperCase() + currentWord.substr(1).toLowerCase() + ' ' + index.charAt(0).toUpperCase() + index.substr(1).toLowerCase();
//     }
...
//     if (isColon) {
//       isColon = false;
//       console.log(currentWord[0].toUpperCase() + currentWord.substr(1).toLowerCase());
//     }
